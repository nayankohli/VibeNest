...
const Login = () => {
    ...
    if (userInfo) {
      toast.success("🎉 Login Successful!", {
        style: {
          ...
          borderRadius: "12px",
          border: isDarkMode ? "2px solid #0ea5e9" : "2px solid #38bdf8",
          textAlign: "center",
          letterSpacing: "0.5px",
  ...
  return (
    <section
      className={`min-h-screen flex items-center justify-center overflow-hidden lg:py-12 transition-colors duration-300 ${
        isDarkMode ? "bg-gray-900" : "bg-green-100"
      }`}
    >
      <div
        className={`w-full max-w-md bg-opacity-95 rounded-xl shadow-2xl p-8 mx-4 transition-all duration-300 transform hover:scale-[1.01] ${
          isDarkMode
            ...
            <div
              className={`relative rounded-lg overflow-hidden border ${
                isDarkMode
                  ...
                  : "border-gray-300 focus-within:border-green-400"
              }`}
            >
              <div
            ...
            >
              <div className="">
                ...
                <input
                  ...
                  className={`w-full p-4 pl-10 rounded border ${
                    isDarkMode
